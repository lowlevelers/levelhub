...
export default () => {
  ...
  const onSubmit: SubmitHandler<Inputs> = async data => {
    ...
    if (validateImages() && (await validateToolName())) {
      ...
      const weeks = await productService.getWeeks(
        currentWeek > launchWeek ? currentYear + 1 : currentYear,
        2
      );
      ...
      await productService
        ...
        .then(async res => {
          ...
          const toolURL = `https://apps.openguild.wtf/tool/${res?.slug}`;
        ...
        <FormLaunchWrapper onSubmit={handleSubmit(onSubmit as () => void)}>
          <FormLaunchSection
            ...
            <div>
              ...
              />
              <LabelError className="mt-2">
                {errors.slogan && 'Please enter your tool slogan'}
              </LabelError>
            </div>
            <div>
          ...
          <FormLaunchSection
            ...
            <div>
              <ul className="text-sm text-gray-400">
                ...
                <li>
                  <b>1. Home Page Spotlight:</b> Your tool will steal the show on our home page for
                  a full 24 hours!
                </li>
                <li>
                  <b>2. Morning Buzz:</b> We'll shoot out an email featuring your tool to our
                  subscribers that very morning.
                </li>
                <li>
                  <b>3. Daily Voting Frenzy:</b> Users will be eager to check out and vote for all
                  of the day's featured tools.
                </li>
              </ul>
              <div className="relative mt-4 mb-3">
                ...
                />
                <LabelError className="mt-2">
                  {errors.weel && 'Please pick a launch week'}
                </LabelError>
              </div>
            </div>
            <div className="pt-7">
