      ...
      <div className="py-4 rounded-2xl flex items-start">
        <div className="w-full flex items-center gap-x-4">
          ...
          <div className="w-full space-y-1">
            <div className="w-28 h-4 rounded-full bg-gray-700"></div>
            <div className="w-48 h-5 rounded-full bg-gray-700"></div>
            <ToolFooter>
        ...
        <div className={`flex-1 self-center flex justify-end duration-1000 delay-150`}>
          <div className="rounded-md bg-gray-700 w-9 h-9"></div>
        </div>
      </div>
    </li>
  );
