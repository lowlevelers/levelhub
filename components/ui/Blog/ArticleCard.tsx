  ...
  return (
    <li key={article.id} className="border-b border-slate-800 py-8">
      ...
      <Link
        ...
        className="block mt-2 mb-3 font-medium text-slate-50 hover:underline duration-150">
        <h2>{article.headline}</h2>
      </Link>
      <div className="text-slate-400 text-sm line-clamp-2  mb-4 block">
      ...
      <div className="flex flex-wrap justify-between gap-3">
        ...
        <Link
          href={`/blog/${article.slug}`}
          className="flex items-center text-sm text-pink-500 hover:text-pink-400 font-medium group">
          Read More
